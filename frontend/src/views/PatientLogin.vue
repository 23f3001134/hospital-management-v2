    ...
    <div class="auth-grid">
      <div class="auth-panel">
        <div class="panel-header">
          ...
          <h2>Welcome Back</h2>
          <p class="subtitle">
            Check appointments, prescriptions, and health updates in one place.
          </p>
        </div>
        ...
        <div class="footer-note">
          New here?
          <router-link to="/patient/register" class="link-strong">Create an account</router-link>
        </div>
      </div>
      ...
      <div class="side-panel">
        ...
        <div class="side-card accent">
          ...
          <p>Reach out to the clinic desk for password resets and support.</p>
        </div>
      </div>
    </div>
  </div>
